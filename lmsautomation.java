        ...
        try {
            ...
            if (siteName.contains("Sathyabama LMS")) {
                ...
                if (customizeBtn.isDisplayed()) {
                    ...
                    System.out.println("Positive validation of login failed");
                }
                ...
                // Click on user menu and navigate to profile
                ...
                // Open hamburger menu and print course options
                ...
                System.out.println("(7/10) Available options in the menu are: ");
